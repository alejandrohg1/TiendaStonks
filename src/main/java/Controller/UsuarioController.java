...
public class UsuarioController implements Initializable {
    ...
    public void loadFromGson() {
        ...
        try {
            usuarioObservableList.addAll(Arrays.asList(gson.fromJson(new FileReader("./src/main/resources/Data/usuarios.json"), Usuario[].class)));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
    ...
    public void addToGson(ObservableList<Usuario> newData) {
        ...
        try {
            flw = new FileWriter("./src/main/resources/Data/usuarios.json");
        } catch (IOException e) {
            e.printStackTrace();
        }
